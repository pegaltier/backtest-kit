...
declare class BrokerAdapter {
    commitCancelScheduled: (_payload: {
        symbol: string;
        cancelId?: string;
        context: {
            strategyName: StrategyName;
    ...
    commitActivateScheduled: (_payload: {
        symbol: string;
        activateId?: string;
        context: {
            strategyName: StrategyName;

...
router.post("/api/v1/mock/candles", async (req, res) => {
  try {
    ...
    ioc.loggerService.log("/api/v1/mock/candles ok", { request, result });
...
router.post("/api/v1/mock/notification", async (req, res) => {
  try {
    ...
    ioc.loggerService.log("/api/v1/mock/notification ok", { request, result });
    return await micro.send(res, 200, result);
  } catch (error) {
...
router.post("/api/v1/mock/storage_one/:id", async (req, res) => {
  try {
    ...
    ioc.loggerService.log("/api/v1/mock/storage_one/:id ok", { request, result });
    return await micro.send(res, 200, result);
  } catch (error) {
...
router.post("/api/v1/mock/storage_list/live", async (req, res) => {
  try {
    ...
    ioc.loggerService.log("/api/v1/mock/storage_list/live ok", { request, result });
    return await micro.send(res, 200, result);
  } catch (error) {
...
router.post("/api/v1/mock/storage_list/backtest", async (req, res) => {
  try {
    ...
    ioc.loggerService.log("/api/v1/mock/storage_list/backtest ok", { request, result });
    return await micro.send(res, 200, result);
  } catch (error) {

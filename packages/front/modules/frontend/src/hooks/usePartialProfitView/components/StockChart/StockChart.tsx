...
const getPositionColor = (position: "long" | "short", index: number): string => {
  if (position === "long") return colors.blue[700];  // LONG - blue
  if (position === "short") return colors.orange[700]; // SHORT - orange
...
export const StockChart = ({
  ...
  }, [source, height, width, items, position, priceOpen, currentPrice, createdAt]);

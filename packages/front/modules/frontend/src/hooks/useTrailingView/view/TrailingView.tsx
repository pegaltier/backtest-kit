...
import trailing_fields from "../../../assets/trailing_fields";

export const TrailingView = ({ data }: IOutletModalProps) => {
  return (
    <Box sx={{ height: "100%", width: "100%", pt: 1 }}>
      <ScrollView withScrollbar hideOverflowX sx={{ height: "100%" }}>
        <div>
          <One slots={defaultSlots} fields={trailing_fields} handler={() => data} />

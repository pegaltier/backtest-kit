...
import ClosePendingCommitView from "./view/ClosePendingCommitView";
...
export const routes: IOutletModal[] = [
  {
    id: "close_pending_commit",
    element: ClosePendingCommitView,
    isActive: (pathname) => hasMatch(["/close_pending_commit"], pathname),
  },
  {
    id: "candle_1m",

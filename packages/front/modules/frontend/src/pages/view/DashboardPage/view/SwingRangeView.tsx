...
import { ioc } from "../../../../lib";
import useSwingRangeArrayPaginator from "../../../../api/useSwingRangeArrayPaginator";
...
const news_swing_range_columns: IColumn[] = [
    {
...
export const SwingRangeView = () => {
    const handler = useSwingRangeArrayPaginator();

    const { render, pickColumns, columns } = useColumnConfig({
        columns: news_swing_range_columns,
        storageKey: "news_swing_range_columns",
    });
    ...
    const handleClick = async (row: any) => {
        ...
        ioc.layoutService.pickSwingRange(row.id);
    };

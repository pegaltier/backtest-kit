...
import { ioc } from "../../../../lib";
import useMastodonArrayPaginator from "../../../../api/useMastodonArrayPaginator";
...
const options: IBreadcrumbs2Option[] = [
    ...
    },
    {
        type: Breadcrumbs2Type.Link,
        action: "back-action",
        label: "Поиск Mastodon",
    },
];

const news_mastodon_columns: IColumn[] = [
    {
...
export const NewsMastodonView = () => {
    const handler = useMastodonArrayPaginator();

    const { render, pickColumns, columns } = useColumnConfig({
        columns: news_mastodon_columns,
        storageKey: "news_mastodon_columns",
    });
    ...
    const handleClick = async (row: any) => {
        ...
        ioc.layoutService.pickMastodonSearch(row.id);
    };
...
export default NewsMastodonView;

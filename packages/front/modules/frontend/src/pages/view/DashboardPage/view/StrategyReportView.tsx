...
import { ioc } from "../../../../lib";
import useStrategyReportArrayPaginator from "../../../../api/useStrategyReportArrayPaginator";
...
const news_strategy_report_columns: IColumn[] = [
    {
...
export const StrategyReportView = () => {
    const handler = useStrategyReportArrayPaginator();

    const { render, pickColumns, columns } = useColumnConfig({
        columns: news_strategy_report_columns,
        storageKey: "news_strategy_report_columns",
    });
    ...
    const handleClick = async (row: any) => {
        ...
        ioc.layoutService.pickStrategyReport(row.id);
    };

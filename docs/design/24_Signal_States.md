...
For information about how signals are generated and validated, see [Signal Generation and Validation](25_Signal_Generation_and_Validation.md). For details on state persistence between crashes, see [Signal Persistence](26_Signal_Persistence.md). For PnL calculation logic in the closed state, see [PnL Calculation](27_PnL_Calculation.md).

---
title: design/08_public_api_reference
group: design
---
...
For detailed implementation details of the underlying service architecture, see [Architecture](04_Architecture.md). For specific execution patterns, see [Backtest API](10_Backtest_API.md) and [Live Trading API](11_Live_Trading_API.md).
...
Functions for registering strategies, exchanges, and timeframes. These must be called before execution begins. See [Configuration Functions](09_Configuration_Functions.md) for detailed documentation.
...
The `Backtest` singleton provides methods for running backtests and generating reports. See [Backtest API](10_Backtest_API.md) for detailed documentation.
...
The `Live` singleton provides methods for live trading execution with crash recovery. See [Live Trading API](11_Live_Trading_API.md) for detailed documentation.
...
Utility functions for accessing market data and execution context. These functions use the current `ExecutionContextService` and `MethodContextService` for implicit context propagation. See [Exchange Functions](12_Exchange_Functions.md) for detailed documentation.
...
Functions for subscribing to signal lifecycle events. All callbacks are processed sequentially using queued async execution. See [Event Listeners](13_Event_Listeners.md) for detailed documentation.
...
|-----------|---------|---------------|
| `IStrategySchema` | Strategy configuration schema | [Configuration Functions](09_Configuration_Functions.md) |
| `IExchangeSchema` | Exchange configuration schema | [Configuration Functions](09_Configuration_Functions.md) |
| `IFrameSchema` | Frame configuration schema | [Configuration Functions](09_Configuration_Functions.md) |
| `ISignalDto` | Signal data transfer object | [Signal Generation and Validation](25_Signal_Generation_and_Validation.md) |
| `ISignalRow` | Complete signal with auto-generated ID | [Signal States](24_Signal_States.md) |
| `IStrategyTickResult` | Discriminated union of all tick results | [Signal States](24_Signal_States.md) |
| `IStrategyPnL` | Profit/loss calculation with fees and slippage | [PnL Calculation](27_PnL_Calculation.md) |
| `ICandleData` | OHLCV candle data point | [Exchange Functions](12_Exchange_Functions.md) |

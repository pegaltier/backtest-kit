---
title: design/34_crash_recovery
group: design
---
...
**Scope**: This page covers signal state persistence, atomic file writes, state recovery on restart, and custom persistence adapters. For information about signal lifecycle states, see [Signal States](24_Signal_States.md). For live trading execution flow, see [Live Execution Flow](33_Live_Execution_Flow.md). For backtest mode (which does not use persistence), see [Backtest Execution Flow](29_Backtest_Execution_Flow.md).
...
![Mermaid Diagram](./diagrams/34_Crash_Recovery_0.svg)
...
![Mermaid Diagram](./diagrams/34_Crash_Recovery_1.svg)
...
![Mermaid Diagram](./diagrams/34_Crash_Recovery_2.svg)
...
![Mermaid Diagram](./diagrams/34_Crash_Recovery_3.svg)
...
![Mermaid Diagram](./diagrams/34_Crash_Recovery_4.svg)
...
![Mermaid Diagram](./diagrams/34_Crash_Recovery_5.svg)
...
![Mermaid Diagram](./diagrams/34_Crash_Recovery_6.svg)
...
![Mermaid Diagram](./diagrams/34_Crash_Recovery_7.svg)

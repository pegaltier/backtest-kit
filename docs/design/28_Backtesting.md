...
This page covers the high-level backtest orchestration, execution flow, and memory-efficient streaming architecture. For detailed API reference, see [Backtest API](10_Backtest_API.md). For signal state management, see [Signal Lifecycle](23_Signal_Lifecycle.md). For timeframe generation specifics, see [Timeframe Generation](30_Timeframe_Generation.md). For fast-forward simulation mechanics, see [Fast-Forward Simulation](31_Fast-Forward_Simulation.md).
...
![Mermaid Diagram](./diagrams/28_Backtesting_0.svg)
...
![Mermaid Diagram](./diagrams/28_Backtesting_1.svg)
...
![Mermaid Diagram](./diagrams/28_Backtesting_2.svg)
...
![Mermaid Diagram](./diagrams/28_Backtesting_3.svg)
...
![Mermaid Diagram](./diagrams/28_Backtesting_4.svg)
...
For detailed report structure and metrics, see [Markdown Report Generation](37_Markdown_Report_Generation.md) and [Performance Metrics](38_Performance_Metrics.md).
...
Backtesting integrates with the signal lifecycle state machine. For complete signal state details, see [Signal Lifecycle](23_Signal_Lifecycle.md).

### State Transitions in Backtest

![Mermaid Diagram](./diagrams/28_Backtesting_5.svg)
...
For fast-forward simulation details, see [Fast-Forward Simulation](31_Fast-Forward_Simulation.md).

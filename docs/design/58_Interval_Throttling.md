---
title: design/58_interval_throttling
group: design
---
...
For information about the broader live trading execution loop, see [Live Execution Flow](./55_Live_Execution_Flow.md). For details on signal generation and validation, see [Signal Generation and Validation](./46_Signal_Generation_and_Validation.md).

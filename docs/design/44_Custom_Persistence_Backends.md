...
For general information about signal persistence and crash recovery mechanisms, see [Signal Persistence](26_Signal_Persistence.md). For implementing custom data sources for candle data, see [Custom Exchange Integration](43_Custom_Exchange_Integration.md).

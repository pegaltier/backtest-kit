...
For information about how `ClientStrategy` is orchestrated within the execution flow, see [Backtest Execution Flow](29_Backtest_Execution_Flow.md) and [Live Execution Flow](33_Live_Execution_Flow.md). For details on the persistence mechanism, see [Signal Persistence](26_Signal_Persistence.md). For PNL calculation specifics, see [PnL Calculation](27_PnL_Calculation.md).

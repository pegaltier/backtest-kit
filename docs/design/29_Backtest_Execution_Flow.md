...
For information about configuring backtests and the Public API, see [Backtest API](10_Backtest_API.md). For details on timeframe generation itself, see [Timeframe Generation](30_Timeframe_Generation.md). For the fast-forward simulation algorithm that processes opened signals, see [Fast-Forward Simulation](31_Fast-Forward_Simulation.md).
...
For details on report generation, see [Markdown Report Generation](37_Markdown_Report_Generation.md).

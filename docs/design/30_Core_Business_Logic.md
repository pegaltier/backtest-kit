...
For information about the service layer that wraps these client classes, see [Service Layer](./36_Service_Layer.md). For details on dependency injection and context propagation, see [Architecture](./09_Architecture.md).
...
- [ClientStrategy](./31_ClientStrategy.md) - Signal lifecycle and monitoring
- [ClientExchange](./32_ClientExchange.md) - Market data and formatting
- [ClientFrame](./33_ClientFrame.md) - Timeframe generation
- [ClientRisk](./34_ClientRisk.md) - Portfolio risk management
- [ClientSizing](./35_ClientSizing.md) - Position sizing algorithms

---
title: design/42_advanced_topics
group: design
---
...
For basic usage of the public API, see [Public API Reference](08_Public_API_Reference.md). For service architecture patterns, see [Service Layer](18_Service_Layer.md). For signal lifecycle fundamentals, see [Signal Lifecycle](23_Signal_Lifecycle.md).

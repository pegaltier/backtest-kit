...
For configuration and registration of strategies, exchanges, and frames, see [Configuration Functions](09_Configuration_Functions.md). For the business logic implementations that Logic Services orchestrate, see [Core Business Logic](14_Core_Business_Logic.md).

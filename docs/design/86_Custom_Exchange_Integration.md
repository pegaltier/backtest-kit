---
title: design/86_custom_exchange_integration
group: design
---
...
![Mermaid Diagram](./diagrams/86_Custom_Exchange_Integration_0.svg)
...
addExchange({
  exchangeName: "database_exchange",
  getCandles: async (symbol, interval, since, limit) => {
...
![Mermaid Diagram](./diagrams/86_Custom_Exchange_Integration_1.svg)
...
![Mermaid Diagram](./diagrams/86_Custom_Exchange_Integration_2.svg)
...
![Mermaid Diagram](./diagrams/86_Custom_Exchange_Integration_3.svg)
...
![Mermaid Diagram](./diagrams/86_Custom_Exchange_Integration_4.svg)

...
### __@WAIT_FOR_INIT_SYMBOL$1@1869

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1869: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1870

```ts
__@WRITE_SAFE_SYMBOL$1@1870: (line: string) => Promise<symbol | void>
```

...
### __@WAIT_FOR_INIT_SYMBOL$1@2376

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2376: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2377

```ts
__@WRITE_SAFE_SYMBOL$1@2377: (line: string) => Promise<symbol | void>
```

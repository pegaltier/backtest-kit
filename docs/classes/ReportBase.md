...
### __@WAIT_FOR_INIT_SYMBOL$1@2252

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2252: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2253

```ts
__@WRITE_SAFE_SYMBOL$1@2253: (line: string) => Promise<symbol | void>
```

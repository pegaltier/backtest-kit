...
### __@WAIT_FOR_INIT_SYMBOL$1@1877

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1877: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1878

```ts
__@WRITE_SAFE_SYMBOL$1@1878: (line: string) => Promise<symbol | void>
```

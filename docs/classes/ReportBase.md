...
### __@WAIT_FOR_INIT_SYMBOL$1@2103

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2103: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2104

```ts
__@WRITE_SAFE_SYMBOL$1@2104: (line: string) => Promise<symbol | void>
```

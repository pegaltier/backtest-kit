...
### __@WAIT_FOR_INIT_SYMBOL$1@2661

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2661: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2662

```ts
__@WRITE_SAFE_SYMBOL$1@2662: (line: string) => Promise<symbol | void>
```

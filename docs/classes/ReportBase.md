...
### __@WAIT_FOR_INIT_SYMBOL$1@1747

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1747: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1748

```ts
__@WRITE_SAFE_SYMBOL$1@1748: (line: string) => Promise<symbol | void>
```

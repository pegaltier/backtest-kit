...
### __@WAIT_FOR_INIT_SYMBOL$1@2936

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2936: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2937

```ts
__@WRITE_SAFE_SYMBOL$1@2937: (line: string) => Promise<symbol | void>
```

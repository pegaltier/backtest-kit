...
### __@WAIT_FOR_INIT_SYMBOL$1@3040

```ts
__@WAIT_FOR_INIT_SYMBOL$1@3040: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@3041

```ts
__@WRITE_SAFE_SYMBOL$1@3041: (line: string) => Promise<symbol | void>
```

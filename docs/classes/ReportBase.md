...
### __@WAIT_FOR_INIT_SYMBOL$1@2734

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2734: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2735

```ts
__@WRITE_SAFE_SYMBOL$1@2735: (line: string) => Promise<symbol | void>
```

...
### __@WAIT_FOR_INIT_SYMBOL$1@1816

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1816: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1817

```ts
__@WRITE_SAFE_SYMBOL$1@1817: (line: string) => Promise<symbol | void>
```

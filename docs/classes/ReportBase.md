...
### __@WAIT_FOR_INIT_SYMBOL$1@3005

```ts
__@WAIT_FOR_INIT_SYMBOL$1@3005: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@3006

```ts
__@WRITE_SAFE_SYMBOL$1@3006: (line: string) => Promise<symbol | void>
```

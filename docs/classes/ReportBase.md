...
### __@WAIT_FOR_INIT_SYMBOL$1@1874

```ts
__@WAIT_FOR_INIT_SYMBOL$1@1874: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@1875

```ts
__@WRITE_SAFE_SYMBOL$1@1875: (line: string) => Promise<symbol | void>
```

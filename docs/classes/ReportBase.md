...
### __@WAIT_FOR_INIT_SYMBOL$1@2956

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2956: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2957

```ts
__@WRITE_SAFE_SYMBOL$1@2957: (line: string) => Promise<symbol | void>
```

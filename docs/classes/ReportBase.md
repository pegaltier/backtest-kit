...
### __@WAIT_FOR_INIT_SYMBOL$1@2060

```ts
__@WAIT_FOR_INIT_SYMBOL$1@2060: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL$1@2061

```ts
__@WRITE_SAFE_SYMBOL$1@2061: (line: string) => Promise<symbol | void>
```

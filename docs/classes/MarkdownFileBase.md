...
### __@WAIT_FOR_INIT_SYMBOL@2800

```ts
__@WAIT_FOR_INIT_SYMBOL@2800: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2801

```ts
__@WRITE_SAFE_SYMBOL@2801: (line: string) => Promise<symbol | void>
```

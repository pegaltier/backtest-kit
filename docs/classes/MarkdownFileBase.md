...
### __@WAIT_FOR_INIT_SYMBOL@2441

```ts
__@WAIT_FOR_INIT_SYMBOL@2441: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2442

```ts
__@WRITE_SAFE_SYMBOL@2442: (line: string) => Promise<symbol | void>
```

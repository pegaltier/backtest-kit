...
### __@WAIT_FOR_INIT_SYMBOL@2168

```ts
__@WAIT_FOR_INIT_SYMBOL@2168: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2169

```ts
__@WRITE_SAFE_SYMBOL@2169: (line: string) => Promise<symbol | void>
```

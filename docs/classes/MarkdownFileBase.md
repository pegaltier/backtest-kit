...
### __@WAIT_FOR_INIT_SYMBOL@2125

```ts
__@WAIT_FOR_INIT_SYMBOL@2125: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2126

```ts
__@WRITE_SAFE_SYMBOL@2126: (line: string) => Promise<symbol | void>
```

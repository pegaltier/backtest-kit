...
### __@WAIT_FOR_INIT_SYMBOL@3109

```ts
__@WAIT_FOR_INIT_SYMBOL@3109: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@3110

```ts
__@WRITE_SAFE_SYMBOL@3110: (line: string) => Promise<symbol | void>
```

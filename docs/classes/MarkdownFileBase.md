...
### __@WAIT_FOR_INIT_SYMBOL@1881

```ts
__@WAIT_FOR_INIT_SYMBOL@1881: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1882

```ts
__@WRITE_SAFE_SYMBOL@1882: (line: string) => Promise<symbol | void>
```

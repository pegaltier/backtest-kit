...
### __@WAIT_FOR_INIT_SYMBOL@1933

```ts
__@WAIT_FOR_INIT_SYMBOL@1933: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1934

```ts
__@WRITE_SAFE_SYMBOL@1934: (line: string) => Promise<symbol | void>
```

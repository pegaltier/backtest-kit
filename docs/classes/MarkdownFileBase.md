...
### __@WAIT_FOR_INIT_SYMBOL@1939

```ts
__@WAIT_FOR_INIT_SYMBOL@1939: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1940

```ts
__@WRITE_SAFE_SYMBOL@1940: (line: string) => Promise<symbol | void>
```

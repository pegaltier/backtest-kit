...
### __@WAIT_FOR_INIT_SYMBOL@2317

```ts
__@WAIT_FOR_INIT_SYMBOL@2317: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2318

```ts
__@WRITE_SAFE_SYMBOL@2318: (line: string) => Promise<symbol | void>
```

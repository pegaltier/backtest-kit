...
### __@WAIT_FOR_INIT_SYMBOL@3003

```ts
__@WAIT_FOR_INIT_SYMBOL@3003: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@3004

```ts
__@WRITE_SAFE_SYMBOL@3004: (line: string) => Promise<symbol | void>
```

...
### __@WAIT_FOR_INIT_SYMBOL@2727

```ts
__@WAIT_FOR_INIT_SYMBOL@2727: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@2728

```ts
__@WRITE_SAFE_SYMBOL@2728: (line: string) => Promise<symbol | void>
```

...
### __@WAIT_FOR_INIT_SYMBOL@1942

```ts
__@WAIT_FOR_INIT_SYMBOL@1942: (() => Promise<void>) & ISingleshotClearable
```
...
### __@WRITE_SAFE_SYMBOL@1943

```ts
__@WRITE_SAFE_SYMBOL@1943: (line: string) => Promise<symbol | void>
```
